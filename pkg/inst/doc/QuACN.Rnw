...
We integrated 4 different information functionals \cite{dehmer_functionals_2008, dehmer_degree_2010}:
...
\subsubsection*{Prime ID number \cite{randic1984molecular}:}
